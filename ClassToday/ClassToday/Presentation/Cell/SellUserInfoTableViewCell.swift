//
//  SellUserInfoTableViewCell.swift
//  Practice
//
...
class SellUserInfoTableViewCell: UITableViewCell {
...
extension SellUserInfoTableViewCell: UICollectionViewDelegateFlowLayout {
    func collectionView(
...
extension SellUserInfoTableViewCell: UICollectionViewDataSource {
    func collectionView(
        _ collectionView: UICollectionView,
...
private extension SellUserInfoTableViewCell {
    func layout() {
        [
            titleLabel,
            buyCollectionView
